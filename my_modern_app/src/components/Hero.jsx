...
// function Hero() {
//   return (
//     <section id="home" className={`fles md:flex-row flex-col ${styles.flexStart}`}>
//       <div className={`flex-1 ${styles.flexStart} flex-col x1:px-0 sm:px-16 px-6`}>
//         <div className='flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2' >
//           <img src={discount} about alt='discount' className='w-[32px] h-[32px'/>
//           <p className={`${styles.paragraph} ml-2`}>
//             <span className='text-white'> 20% </span>
//             <span> Discountb for {"  "}</span>
...
//         <div className='absolute z-[0] w-[80%] h-[80%] top-0 white__gradient rounded-full bottom-40'></div>  
